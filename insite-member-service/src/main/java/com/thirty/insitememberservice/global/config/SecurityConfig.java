package com.thirty.insitememberservice.global.config;


import com.thirty.insitememberservice.global.config.jwt.JwtAuthenticationFilter;
import com.thirty.insitememberservice.global.util.CustomResponseUtil;
...
//			.authenticated() //포스트맨으로 http://localhost:8081/api/admin/dsd 이런식으로 테스트 해보면 403 에러 확인
		//	.antMatchers("/**")
		//	.hasIpAddress("127.0.0.1"); //api ahteway 아이피만 허용
			.anyRequest()
