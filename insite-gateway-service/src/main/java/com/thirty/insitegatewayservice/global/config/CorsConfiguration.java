package com.thirty.insitegatewayservice.global.config;
...
public class CorsConfiguration {
	private static final String ALLOWED_HEADERS = "RefreshToken, Content-Type, Content-Length, Authorization, credential, X-XSRF-TOKEN";
	private static final String ALLOWED_METHODS = "GET, PUT, POST, DELETE, OPTIONS, PATCH";
	private static final String ALLOWED_ORIGIN = "*";
	private static final String EXPOSE_HEADERS = "RefreshToken, Authorization";
